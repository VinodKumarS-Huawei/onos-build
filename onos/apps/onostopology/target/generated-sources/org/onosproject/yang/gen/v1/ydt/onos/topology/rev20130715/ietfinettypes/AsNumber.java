...
public final class AsNumber {
     ...
     */
    public AsNumber(long uint32) {
        this.uint32 = uint32;
    }

    /**
     * Returns the object of asNumber for type uint32.
     *
     * @param value value of asNumber for type uint32
     * @return asNumber for type uint32
     */
    ...
    /**
     * Returns the object of asNumber fromString input StringasNumber.
     *
