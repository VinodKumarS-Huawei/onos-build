...
/**
 * Pipeliner device behaviour implementation for huawei driver.
 */
public class HuaweiPipeliner extends AbstractHandlerBehaviour implements Pipeliner {
    ...
    public void init(DeviceId deviceId, PipelinerContext context) {
        /*
         * Right now we are able to map flow objectives only in the first
